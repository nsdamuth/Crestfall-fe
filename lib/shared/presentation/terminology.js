...
export const CREATION_TYPE_DISPLAY_NAMES = {
  ...
  RULES_CODEX: "Rules Codex", // owner ruling 6 Sep 2026 (FE/FILTERS): one name sitewide, allowlisted by this exact string in the retired-word check; supersedes the 26 Aug 2026 "Rulebook" label; backend value RULES_CODEX unchanged
  LORE: "Lore Asset",
  TIMELINE: "Timeline",
