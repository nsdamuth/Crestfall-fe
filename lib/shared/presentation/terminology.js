...
// Three user-facing tiers over the three backend values
// (lib/server/creations/constants.js: SFW, MATURE, EXPLICIT). Film
// anchors surface as the row tooltip (native title attribute,
// interim pending a design-system tooltip pattern, flagged in
// docs/CONTRACT-REQUESTS.md CR-027), never as the tier label or a
// visible description line. Whether the backend should carry a
// fourth tier is deferred to Nick (CR-027), pending the
// CRESTFALL-CONTENT-STANDARDS.md (draft) revision.
