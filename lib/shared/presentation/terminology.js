...
export const CREATION_TYPE_DISPLAY_NAMES = {
  ...
  MECHANICS_ACTION: "Mechanics Action",
  MECHANICS_ACTION_SET: "Mechanics Action Set",
  RULES_CODEX: "Rules Codex", // owner ruling 6 Sep 2026 (FE/FILTERS): one name sitewide, allowlisted by this exact string in the retired-word check; supersedes the 26 Aug 2026 label; backend value RULES_CODEX unchanged
  LORE: "Lore Asset",
  TIMELINE: "Timeline",
...
// MATURE is Young Adult, EXPLICIT is Adult. No disabled row, no
// interim note, no NC-17 anywhere. Film anchors surface as the row
// tooltip (native title attribute), never as the tier label or a
// visible description line.
//
// Display word for the MATURE tier changed Teen to Young Adult, RULED
// 23 Aug 2026 (Brian, build-0823 close-out session): platform-wide
// display supersession, FE display layer only. The internal tier id
// ("TEEN"), the backend enum value ("MATURE"), and the tooltip film
// anchor are all unchanged; only the rendered label word changes.
// Everyone and Adult are unchanged.
