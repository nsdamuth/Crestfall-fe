...
import {
  selectionCardEmptyFixture,
  selectionCardLongContentFixture,
  selectionCardMissingIconFixture,
  selectionCardNarratorFixture,
  selectionCardScenarioFixture,
  selectionCardTitleOnlyFixture,
} from "@/components/studio/room-templates/selection-card/SelectionCard.fixtures";

const PREVIEW_STATES = [
  { label: "Selected Scenario", props: selectionCardScenarioFixture },
  { label: "Selected Narrator", props: selectionCardNarratorFixture },
  { label: "Empty Optional Location", props: selectionCardEmptyFixture },
  { label: "Title Only", props: selectionCardTitleOnlyFixture },
  { label: "Missing Icon Fallback", props: selectionCardMissingIconFixture },
  { label: "Long Content", props: selectionCardLongContentFixture },
];

export default function SelectionCardPreviewClient() {
    ...
    <main className="min-h-screen bg-[#080706] px-4 py-10 text-[var(--foreground)] sm:px-6">
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="rounded-2xl border border-[var(--muted-gold)]/25 bg-black/35 p-6">
          ...
          <h1 className="mt-2 font-display text-4xl">Selection Card</h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--muted)]">
            This route renders the portable create-flow card directly from
