...
import {
  selectedCharactersEditEmptyFixture,
  selectedCharactersEditLongContentFixture,
  selectedCharactersEditMultipleFixture,
  selectedCharactersEditNoSubtitleFixture,
  selectedCharactersEditSingleFixture,
} from "@/components/studio/create/room-template/selected-characters-panel/SelectedCharactersPanel.fixtures";

const PREVIEW_STATES = {
  empty: {
    label: "Empty",
    props: selectedCharactersEditEmptyFixture,
  },
  single: {
    label: "One Character",
    props: selectedCharactersEditSingleFixture,
  },
  multiple: {
    label: "Several Characters",
    props: selectedCharactersEditMultipleFixture,
  },
  noSubtitle: {
    label: "No Subtitle",
    props: selectedCharactersEditNoSubtitleFixture,
  },
  longContent: {
    label: "Long Content",
    props: selectedCharactersEditLongContentFixture,
  },
};

const PREVIEW_ADDITION = {
  id: "character-edit-preview-guest",
  title: "Edit Preview Guest",
  subtitle: "Added only inside the isolated Story edit preview",
  initial: "E",
};

export default function SelectedCharactersPanelEditPreviewClient() {
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="rounded-2xl border border-[var(--muted-gold)]/25 bg-black/35 p-6">
          ...
          <h1 className="mt-2 font-display text-4xl">
            Story Edit Selected Characters Panel
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--muted)]">
            This route renders the Story edit portable View directly from
            contract-shaped fixtures. It does not open the real creation
            picker, modify a Story package, attach participants, or save data.
          </p>
        </header>
