...
function apiError(message, status = 500, code = "ENGINE_MODULE_BINDING_FAILED") {
...
export async function DELETE(_request, { params }) {
  ...
  if (!moduleId) {
    return apiError(
      ...
      400,
      "ENGINE_MODULE_BINDING_MODULE_ID_REQUIRED"
    );
  }
  ...
  try {
    ...
    return apiError(
      error.message || "Engine module binding could not be deleted.",
      500,
      "ENGINE_MODULE_BINDING_DELETE_FAILED"
    );
  }
}