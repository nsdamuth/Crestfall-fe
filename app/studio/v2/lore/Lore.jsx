...
// is the one piece of application wiring Lore needs; everything else
// is presentation, delegated to the ViewModel and View. The
// fixture-mode harness (full / empty / pending approval) is dev-only
// QA scaffolding, never product, per docs/FRONTEND-SOP.md section 2
// ("app/dev/ui-preview never product" carried here as the same rule
// for this pre-parity staging page).
import { useState } from "react";
import { useRouter } from "next/navigation";

import LoreView from "./lore/Lore.view";
import { useLoreViewModel } from "./lore/useLoreViewModel";
