...
export default function TimelineCard({ entry }) {
  ...
  return (
    <article className={`relative ${alignment}`}>
      ...
      <Link
        href={entry.slug}
        className="group block border border-[var(--line-strong)] bg-[var(--surface-2)] p-6 transition hover:-translate-y-1 hover:border-[var(--muted-gold)] hover:bg-[rgba(20,16,12,0.9)]"
      >
