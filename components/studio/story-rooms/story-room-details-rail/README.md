...
- the description clamp toggle (review round 6: two lines collapsed, "See more" floated to the end of the second line; the three-dot menu is gone, Delete story is the chat shell's red trash control beside the rail toggle, opening the shell's confirm)
