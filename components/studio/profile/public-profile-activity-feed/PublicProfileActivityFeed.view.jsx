...
export default function PublicProfileActivityFeedView({
  ...
  if (!safeEvents.length) {
    return (
      <div className="mx-auto mt-5 w-full max-w-5xl rounded-[var(--radius-md)] border border-dashed border-white/10 bg-[var(--surface-1)] p-8 text-center">
...
function CreationActivityRow({ event, LinkComponent }) {
  ...
  return (
    <article className="rounded-[var(--radius-md)] border border-white/10 bg-[var(--surface-1)] p-4">
