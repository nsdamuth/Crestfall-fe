        ...
        >
          <div className="flex items-start gap-4">
            {badge?.imageUrl ? (
              ...
              <div className="flex min-h-10 shrink-0 items-center justify-center rounded-full border border-[var(--muted-gold)]/35 bg-[var(--muted-gold)]/10 px-4 py-2 text-center text-xs font-semibold uppercase tracking-[0.16em] text-[var(--muted-gold)]">
                {badge?.label || "Badge"}
              </div>
            )}
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-[10px] uppercase tracking-[0.2em] text-[var(--muted-gold)]">
