  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-[var(--gold-ornament)]/20 bg-black/30 shadow-2xl shadow-black/30">
      ...
      >
        {!bannerUrl ? (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="rounded-2xl border border-[var(--gold-ornament)]/20 bg-black/30 px-6 py-4 text-center backdrop-blur">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="flex items-end gap-4">
              ...
              <div className="pb-1">
                ...
                <h1 className="mt-2 font-serif text-4xl text-[var(--ink)] md:text-5xl">
                  {displayName}
                </h1>

                <p className="mt-2 text-sm text-[var(--ink-dim)]">@{username}</p>
      ...
      <div className="px-5 pb-6 pt-16 md:px-8">
        <p className="max-w-4xl text-sm leading-7 text-[var(--ink-dim)]">
          {bio}
        </p>
      </div>
    </section>
