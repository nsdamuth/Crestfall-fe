...
const PANEL_CLASS_NAME =
  "relative max-h-[92vh] w-full max-w-4xl overflow-y-auto overscroll-contain rounded-[var(--radius-md)] border border-[var(--muted-gold)]/25 bg-[#080706] shadow-2xl lg:overflow-hidden";
