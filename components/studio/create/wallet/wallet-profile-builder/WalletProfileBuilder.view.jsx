    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-[var(--muted-gold)]/20 bg-black/35 p-5">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
          Create reusable gameplay currency definitions for Actor Mechanics
          Profiles. Live balances remain actor-owned state and Studio Coins stay separate.
        </p>
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-2">
          <Field label="Creation title">
            <input
              ...
              value={title}
              onChange={(event) =>
                onUpdateIdentity?.("title", event.target.value)
              }
            />
          </Field>
