...
export default function AbilitySpellProfileJsonEditorModalView({
      ...
      <div className="flex shrink-0 flex-col gap-4 border-b border-white/10 p-5 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-4xl text-xs leading-5 text-[var(--muted)]">
            Applying updates the open Ability & Spell Profile editor. The normal page
        ...
        <div className="flex shrink-0 flex-wrap items-center justify-end gap-2">
          ...
          <button
            ...
            aria-label="Close Ability & Spell Profile JSON Editor"
          >
            <X size={18} />
          </button>
        </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.18em] text-[var(--muted-gold)]">
                <Code2 size={14} />
                Authored Ability & Spell Profile
              </p>
        ...
        <aside className="grid content-start gap-4">
          <section className="rounded-xl border border-[var(--muted-gold)]/20 bg-[var(--muted-gold)]/5 p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--muted)]">
              The complete Ability & Spell Profile is parsed, contract-checked,
          ...
          <section className="rounded-xl border border-white/10 bg-black/25 p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--muted)]">
              The download contains the current Ability & Spell Profile JSON,
              definition contracts, policy rules, limits, actor-state
