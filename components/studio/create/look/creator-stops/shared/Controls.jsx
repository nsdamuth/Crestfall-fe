...
// Local to the Looks quick create, mirroring the World quick create's
// own package-local shared/Controls.jsx (the Q1 world-quick-create
// precedent, itself mirroring Character's): the field list differs,
// so this package carries its own copy of the handful of primitives it
// needs rather than importing World's or Character's, keeping the
// three packages independently editable. Same recipes, same classes,
// same law.
...
// Character quick create, and the World quick create use.
