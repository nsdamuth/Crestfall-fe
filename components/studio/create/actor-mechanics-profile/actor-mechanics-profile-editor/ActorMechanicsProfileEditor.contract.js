...
export const ACTOR_MECHANICS_PROFILE_EDITOR_VIEW_CONTRACT_VERSION = "1.5.0";
...
export const ACTOR_MECHANICS_PROFILE_SKILLS_CREATION_TYPE =
  "SKILLS_PROFILE";
export const ACTOR_MECHANICS_PROFILE_SKILLS_CONTRACT_VERSION =
  "skills_profile_contract_v0";
export const ACTOR_MECHANICS_PROFILE_ABILITY_SPELL_CREATION_TYPE =
  "ABILITY_SPELL_PROFILE";
export const ACTOR_MECHANICS_PROFILE_ABILITY_SPELL_CONTRACT_VERSION =
  "ability_spell_profile_contract_v0";
export const ACTOR_MECHANICS_PROFILE_WALLET_CREATION_TYPE =
  "WALLET_PROFILE";
export const ACTOR_MECHANICS_PROFILE_WALLET_CONTRACT_VERSION =
