...
export default function LoreJsonEditorModalView({
  ...
  return (
    <ModalShell
      ...
      panelClassName="max-h-[94vh] w-full max-w-7xl overflow-hidden rounded-2xl border border-[var(--muted-gold)]/25 bg-[#080706] shadow-2xl"
    >
        ...
        <aside className="grid content-start gap-4">
          <section className="rounded-xl border border-[var(--muted-gold)]/20 bg-[var(--muted-gold)]/5 p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--muted)]">
              The complete Lore document is parsed, contract-checked,
          ...
          <section className="rounded-xl border border-white/10 bg-black/25 p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--muted)]">
              The download contains the current Lore JSON, supported block
              shapes, limits, reference rules, and instructions for an AI to
              return one complete replacement object.
            </p>
          </section>
