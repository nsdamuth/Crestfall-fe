...
assert.doesNotMatch(entries.editorView, /Liked/);
assert.doesNotMatch(entries.editorVm, /fetchCommunityCreations|fetchCreationReactions/);
...
assert.match(entries.editorContract, /maxDocumentCharacterRefs:\s*6/);
...
assert.match(entries.rendererView, /lore-parchment-page/);
assert.doesNotMatch(entries.rendererView, /sourcebook-page lore-parchment-page/);
