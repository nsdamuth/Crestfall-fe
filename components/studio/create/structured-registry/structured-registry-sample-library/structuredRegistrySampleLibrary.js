...
const QUEST_SAMPLES = Object.freeze([
  Object.freeze({
    ...
    entry: sampleEntry({
      ...
      rewardSummary: "Example: payment is offered for verified completion; replace these terms with the world's authored economy.",
      monetaryRewards: [
        { amount: "25", currency: "Local currency", condition: "On verified completion" },
      ],
      itemRewards: [],
      otherRewards: [],
  ...
  Object.freeze({
    ...
    entry: sampleEntry({
      ...
      rewardSummary: "Example: a modest delivery fee plus an optional item or favor for exceptional service.",
      monetaryRewards: [
        { amount: "10", currency: "Local currency", condition: "On confirmed delivery" },
      ],
      itemRewards: [
  ...
  Object.freeze({
    ...
    entry: sampleEntry({
      ...
      rewardSummary: "Example: successful service may earn standing or a favor rather than money.",
      monetaryRewards: [],
      itemRewards: [],
      otherRewards: [
