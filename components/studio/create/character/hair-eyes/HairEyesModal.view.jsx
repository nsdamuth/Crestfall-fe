...
function ColorSection({
  ...
  return (
    <div className="mt-[var(--space-6)] first:mt-0">
      ...
      <div className="mt-[var(--space-3)] grid gap-[var(--space-2)] sm:grid-cols-3 lg:grid-cols-9">
...
function OptionSection({
  ...
  return (
    <div className="mt-[var(--space-6)] first:mt-0">
      ...
      <div className="mt-[var(--space-3)] grid gap-[var(--space-2)] sm:grid-cols-2 lg:grid-cols-5">
        {(section?.options || []).map((option) => {
          const active = option?.isCustom
            ? Boolean(section?.customActive)
            : !section?.customActive &&
