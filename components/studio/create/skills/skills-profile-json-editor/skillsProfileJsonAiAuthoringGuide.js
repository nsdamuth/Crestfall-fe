import { SKILLS_PROFILE_LIMITS } from "../skills-profile-editor/SkillsProfileEditor.contract.js";
...
Actor configuration contract: skills_actor_configuration_v1
...
- actorConfiguration may define reusable starter-skill selection slots, but never stores a player's actual selections or ranks.
...
- Maximum skills: ${SKILLS_PROFILE_LIMITS.maxSkills}. Maximum ranks per skill: ${SKILLS_PROFILE_LIMITS.maxRanksPerSkill}.
- starterSelection.mode is NONE or SLOTS.
- SLOTS may define up to 16 reusable starter slots. Each slot has id, title, targetRank, required, and metadata.
- Slot targetRank must be reachable by at least one enabled skill.
- requireUniqueSkills=true means one skill cannot satisfy multiple starter slots.
...
## Complete shape
{
  ...
  "defaultPointCost": 1,
  "actorConfiguration": {
    "version": "skills_actor_configuration_v1",
    "starterSelection": {
      "mode": "SLOTS",
      "requireUniqueSkills": true,
      "slots": [
        {
          "id": "starter.primary",
          "title": "Primary Starter Skill",
          "targetRank": 5,
          "required": true,
          "metadata": {}
        },
