...
//   tone, look), an additive extension noted on the shared view's own
//   contract (creator-stops.view.v3 to v4). Character's icons are
//   unchanged.
//
...
// package uses the smallest sensible set: name, premise, setting or
// genre, tone, look (the art/preview stop). This is an ASSUMPTION for
// Brian to rule on, not a canonical allocation read from a source
// document.
//
// Field order, per the brief: name first, essence (now premise) next,
