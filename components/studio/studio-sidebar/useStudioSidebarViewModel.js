...
// FIX 2): Home and Studio shared one glyph. Studio now carries the
// workshop glyph from the same lucide set, unique in the sidebar.
export const STUDIO_SIDEBAR_PREVIEW_GROUPS = Object.freeze([
  ...
  Object.freeze({
    label: "Create",
    items: Object.freeze([
      Object.freeze({ label: "Studio", href: "/studio", iconKey: "hammer", isBuilt: true }),
