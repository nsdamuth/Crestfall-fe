  ...
  return (
    <section className="grid gap-6">
      <div className="rounded-[var(--radius-md)] border border-[var(--gold-ornament)]/25 bg-black/30 p-6">
        <p className="text-xs uppercase tracking-[0.22em] text-[var(--gold-ornament)]">Mechanics M0</p>
      ...
      <div className="grid gap-5 xl:grid-cols-[0.34fr_0.66fr]">
        <aside className="rounded-[var(--radius-md)] border border-white/10 bg-black/25 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-[var(--gold-ornament)]">Frozen fixtures</p>
        ...
        <div className="rounded-[var(--radius-md)] border border-white/10 bg-black/25 p-5">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-[var(--gold-ornament)]">Selected fixture</p>
      ...
      <div className="grid gap-5 xl:grid-cols-2">
        <div className="rounded-[var(--radius-md)] border border-white/10 bg-black/25 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-[var(--gold-ornament)]">External repositories</p>
        ...
        <div className="rounded-[var(--radius-md)] border border-white/10 bg-black/25 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-[var(--gold-ornament)]">Deferred cross-tier gates</p>
