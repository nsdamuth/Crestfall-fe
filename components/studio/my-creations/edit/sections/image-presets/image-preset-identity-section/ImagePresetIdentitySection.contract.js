export const IMAGE_PRESET_IDENTITY_SECTION_VIEW_CONTRACT_VERSION = "1.0.0";

/**
 * Stable UI boundary for the portable Image Preset identity View.
 *
 * The View must not inspect a creation form, know Image Preset JSON storage
 * fields, resolve legacy style-family fields, parse tag strings into arrays,
 * or decide how identity changes are persisted. It renders display-ready
 * values and emits semantic edit intent only.
 *
 * @typedef {Object} ImagePresetIdentitySectionViewProps
