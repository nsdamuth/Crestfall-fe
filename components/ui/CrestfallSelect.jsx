  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      <button
        ...
        className="mt-2 flex w-full items-center justify-between rounded-xl border border-white/10 bg-[var(--surface-1)] px-4 py-3 text-left text-sm text-[var(--ink)] outline-none transition hover:border-[var(--gold-ornament)]/35 focus:border-[var(--gold-ornament)]/50"
      >
