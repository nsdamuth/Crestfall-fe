...
// no-art fallback surface rule, revised 30 Aug 2026 to use a semantic
// Crestfall identity background instead of automatic legacy stock art. Corner tier is
    ...
    >
      {hasImage ? (
        ...
        <div className="absolute inset-0">
          <KitArtPlaceholderView size="md" identityKey={identityKey || label} />
        </div>
      )}
      <div
        aria-hidden="true"
