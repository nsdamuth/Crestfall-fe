...
// KitPanelToggle.view: the panel toggle glyph and the bare icon
// recipe (contract 1.0.0, lifted 14 Sep 2026 from the story chat
// shell's RailPanelGlyph, ASSET-FOLDERS package AF2, unchanged). The
// bare icon ruled 10 Sep 2026 (no circle, no fill, dim ink at rest,
// gold on hover, deep gold pressed, 44px target, the global focus
// ring). One file, imported by the primary sidebar's collapse
// toggle, the story chat shell's two rail edge toggles, and the
// composer's mobile story list button, so none of them drift.
//
...
// (the primary sidebar, the story list) open is the resting
// orientation; for the details rail on the right edge open is the
// turned one. The global reduced-motion rule in
// app/design-system.css zeroes the transition.
...
export default function KitPanelToggleView({ side = "left", open = false }) {
