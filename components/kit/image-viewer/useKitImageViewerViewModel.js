...
export function useKitImageViewerViewModel(props) {
  ...
  return {
    ...
    assignOpen: Boolean(props?.assignOpen),
    assignPanel: props?.assignPanel ?? null,
    ...
    onCloseAssign: toCallback(props?.onCloseAssign),
    onAssignDestinationChange: toCallback(props?.onAssignDestinationChange),
    onSubmitAssign: toCallback(props?.onSubmitAssign),
