...
export default function VideoDirectorJsonEditorModalView({
      ...
      <div className="grid gap-4 p-5 xl:grid-cols-[minmax(0,1fr)_22rem]">
        <section className="min-w-0">
          ...
          <textarea
            ...
            spellCheck={false}
            aria-label="Video Director JSON"
            className="mt-4 min-h-[52vh] w-full resize-y rounded-xl border border-white/10 bg-[var(--surface-1)] px-4 py-4 font-mono text-xs leading-6 text-[var(--ink)] outline-none transition placeholder:text-[var(--ink-dim)] focus:border-[var(--gold-ornament)]/55"
          />
        </section>
        ...
        <aside className="grid content-start gap-4">
          <section className="rounded-xl border border-[var(--gold-ornament)]/20 bg-[var(--gold-ornament)]/5 p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--ink-dim)]">
              Validate & Apply updates only the current Video composer prompt,
              Director cues, duration, aspect ratio, and quality. It does not
              save, submit, or call a video backend.
            </p>
          </section>
          ...
          <section className="rounded-xl border border-white/10 bg-[var(--surface-2)] p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--ink-dim)]">
              ...
              remain manually selected in Crestfall. UUIDs and media ids are
              rejected from this JSON contract.
            </p>
          </section>
          ...
          <section className="rounded-xl border border-white/10 bg-[var(--surface-2)] p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[var(--ink-dim)]">
              The download contains the current Director JSON, exact timing
              law, current setting values, and instructions for an AI to
              return one complete asset-free replacement object.
            </p>
          </section>
          ...
          <IssueList
            title={`${errors.length} Validation ${
